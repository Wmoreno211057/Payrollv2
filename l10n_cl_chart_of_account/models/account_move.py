...
class AccountMove(models.Model):
    ...
    # @api.depends('invoice_line_ids.price_subtotal', 'amount_tax.amount',
    #              'amount_tax.amount_rounding',
    ...
    #         amount_untaxed_signed = currency_id._convert(self.amount_untaxed, self.company_id.currency_id, self.company_id, self.invoice_date or fields.Date.today())
...
class AccountMoveLine(models.Model):
    ...
    def _compute_price(self):
        ...
        if self.move_id.currency_id and self.move_id.currency_id != \
